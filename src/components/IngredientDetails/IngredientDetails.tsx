    ...
    return (
        ...
        <div className={`${StyleProductDetails.container}`}>
            ...
            <div className={`${StyleProductDetails.description}`}>
                ...
                <h3 className={`text text_type_main-medium`} data-id="ingredient-name">{data.name}</h3>
                ...
                <table className={`${StyleProductDetails.energyValue} mt-8 mb-15`}>
                    ...
                    <tr>
                        <th className="text text_type_main-default text_color_inactive" data-id="ingredient-calories">{data.calories}</th>
                        <th className="text text_type_main-default text_color_inactive" data-id="ingredient-proteins">{data.proteins}</th>
                        <th className="text text_type_main-default text_color_inactive" data-id="ingredient-fat">{data.fat}</th>
                        <th className="text text_type_main-default text_color_inactive"
                            data-id="ingredient-carbohydrates">{data.carbohydrates}</th>
                    </tr>
                    </tbody>
                </table>
            </div>
